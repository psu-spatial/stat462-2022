...
You created the model correctly.  In your write up you have summarised the model equation  (including the coefficients as numbers) & summarising units afterwards. You have produced a model summary and written how much variability in the Rotten Tomatoes score is explained by your model.  You have clearly assessed whether the model meets LINE assumptions (2 for each). 
...
You have have thoughtfully answered these questions and followed instructiion
...
You have correctly predicted the new lake in step 13.
