...
For plots, we have a few choices.  We can use what is built into R, or.. use the ggplot system where you add on layers to your plot using the + symbol
...
See this tutorial for all the details: https://www.datamentor.io/r-programming/box-plot/
This goes through exactly what each line means.
...
We can get more complex using ggplot2. Note for now, think of the %>% symbol and + symbol also as "one command on multiple lines.."
...
```{r, Tut6fig2, echo=FALSE,fig.cap="*R graph gallery*"}
...
There is also a *beautiful* package here called ggstatsplot (https://indrajeetpatil.github.io/ggstatsplot/)

and a detailed tutorial here https://www.r-graph-gallery.com/web-violinplot-with-ggstatsplot.html
...
Or we can customise it even more using the tutorial to get results like this:


```{r, Tut6fig3, echo=FALSE,fig.cap="*GGStatsplot*"}
...
To come tomorrow, but google R tutorial histogram and you will see many

<br>

## Beeswarm plots

These are cool, tutorial to come tomorrow
