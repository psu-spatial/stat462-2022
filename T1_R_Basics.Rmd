...
install.packages(c("tidyverse","abind","car","corrplot","dismo",
                  ...
                  "Stat2Data","tmap","units","viridis","yarrr"))
...
For example, this command *forces* the computer to use the 'raster package' version of filter.

```{r, eval=FALSE}
raster::filter(mydata)
```
...
The text part of your document is anywhere outside your YAML code or a code chunk (see \@ref(fig:tut2afig2)).  
