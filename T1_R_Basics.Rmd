...
Here is a great summary of the differences between
them:
...
# add axes and title
axis(side=1, at=pretty(m,10), col.axis=palette[7], cex.axis=0.8, lty=0, tick=NA, line=-1)
axis(side=1, at=50, labels="Price (Thousand USD)", lty=0, tick=NA, col.axis=palette[7])
axis(side=2, at=1, col.axis=palette[7], cex.axis=0.8, lty=0, tick=NA, labels="Sample 1", las=2)
...
Or the version that includes a lot of associated statistics.  You can turn many of these on and off
...
```{r, Tut6fig3c, echo=FALSE,fig.cap="*GGStatsplot*"}
