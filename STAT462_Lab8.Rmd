...
**Step 9: PREDICTING AN INDEPENDENT DATASET**.  YOU SHOULD BE USING THE **TEST** DATASET. 

So we have withheld 200 values from your model, that I set aside in my "test data".  They come from the same population.  We are now going to see how your  model works on the new data.
