...
You might find Tutorial Y useful (the code is in there!). 
...
3. Use tutorial XX to read it into R.  
...
2. Read it into R and calculate the correlation coefficient.  

3. Explain why this correlation coefficient is vastly inappropriate!


No show me something new this lab :)
